...
@pytest.mark.parametrize(
  ...
  [
    (
      QSimpleRNN,
      np.array([
        -2.6562500e+00, -4.3466797e+00,  8.6736174e-19,  1.2281364e-01,
        -5.7392116e+00,  8.6736174e-19, -7.5000000e-01,  0.0000000e+00], dtype=np.float32),
      np.array([
    ...
    (
      QLSTM,
      np.array([
        -4.1406555,  3.2921143, 16.       ,  7.0236816,  3.3590946,
