...
@pytest.mark.parametrize(
    ...
    [
        (3, 0,
        np.array([0.0, 0.125, 0.25, 0.375, 0.5, 0.625, 0.75, 0.875])
        ),
        (3, 1,
        np.array([0.0, 0.25, 0.5, 0.75, 1.0, 1.25, 1.5, 1.75])
        ),
        (3, 2,
        np.array([0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 3.5])
        ),
        (3, 3,
...
@pytest.mark.parametrize(
    ...
    [
        (3, 0,
        np.array([0.0, 0.25, 0.5, 0.75, -1.0, -0.75, -0.5, -0.25])
        ),
        (3, 1,
        np.array([0.0, 0.5, 1.0, 1.5, -2.0, -1.5, -1.0, -0.5])
        ),
        (3, 2,
        np.array([0.0, 1.0, 2.0, 3.0, -4.0, -3.0, -2.0, -1.0])
        ),
        (3, 3,
        np.array([0.0, 2.0, 4.0, 6.0, -8.0, -6.0, -4.0, -2.0])        
        ),
        (6, 1,
        np.array(
